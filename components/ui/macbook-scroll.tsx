...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh] flex flex-col items-center py-0 justify-start flex-shrink-0 [perspective:800px] transform max-[600px]:"
    >
      <motion.h2
        style={{
        ...
        className="dark:text-white max-w-4xl w-full  text-neutral-800 text-3xl font-bold mb-20 text-center"
      >
        {title || (
          <span>
